...
all_indices = list(range(1770))
random.shuffle(all_indices)
train_indices = all_indices[:885]
n =3
eval_indices = all_indices[885:]
...
for trial_idx, spikes in enumerate(spike_indices_c):
    st_c = SpikeTrain(spikes.flatten() / 10 * ms, t_stop=1500)
...
if __name__ == '__main__':
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V3/results/V3_control_VP_results.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V3_control_VP_results.pkl") 

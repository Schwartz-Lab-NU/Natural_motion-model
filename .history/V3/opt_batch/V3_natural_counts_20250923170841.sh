...
#SBATCH --job-name=V3_natural_counts  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=V3_natural_counts ## standard out and standard error goes to this file

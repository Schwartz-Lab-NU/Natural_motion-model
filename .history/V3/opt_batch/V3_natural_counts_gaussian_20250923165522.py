...
if __name__ == '__main__':
    ...
    np.savez("V3_natural_counts_sigmas.npz", sigmas=sigmas, scores=scores)
    # res = minimize(
    #     sigma_objective,
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V3/results/V3_natural_counts_gaussian.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V3_natural_counts_gaussian.pkl") 

...
if __name__ == '__main__':
    ...
    global BEST_ERRORS_TRAIN
    global BEST_ERRORS_EVAL
    GLOBAL_LINEAR = None
    BEST_DE_PARAMS = None
    BEST_DE_SCORE  = None
    BEST_SIGMA = None
    BEST_ITERATIONS = None
    BEST_ERRORS_TRAIN = None
    BEST_ERRORS_EVAL = None
    sigmas = np.linspace(60, 130, 71)   # 1-unit steps from 10 to 100
    ...
    np.savez("V3_natural_counts_sigmasstep1.npz", sigmas=sigmas, scores=scores)
    # res = minimize(
    #     sigma_objective,
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V3/results/V3_natural_counts_gaussianstep1.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V3_natural_counts_gaussianstep1.pkl") 

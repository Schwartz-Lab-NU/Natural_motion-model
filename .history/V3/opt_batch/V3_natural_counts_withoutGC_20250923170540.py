...
rfN = np.load('/projects/p32750/repository/Natural_motion-model/V3/results/rfNc2_V3_training_only.npy')
rfN[rfN < 0.1] = 0
...
if __name__ == '__main__':
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V3/results/V3_natural_counts_withoutGC.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V3_natural_counts_withoutGC.pkl") 

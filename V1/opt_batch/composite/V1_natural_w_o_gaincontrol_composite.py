...
stimttype = 'natural_w/o_gaincontrol'
...
def objectiveVP(params, train=True):
    try:
        ...
        # For natural_w/o_gaincontrol stimulus type, we use spatial_filterSF and B=0 (no gain control)
        B = 0  # No gain control
        A =1
        tau =1
        spike_trainGCvpfit = []
...
# Define bounds for gain, max_rate, y, theta (B=0 for no gain control)
bounds = [
          (0.001, 0.01),   # gain
          (150, 400),      # max_rate
          (-600, 4000),     # y
...
if __name__ == '__main__':
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_natural_w_o_gaincontrol_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_natural_w_o_gaincontrol_composite.pkl") 
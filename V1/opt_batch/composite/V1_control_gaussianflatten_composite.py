...
stimttype = 'control_gaussianflatten'
...
def objectiveVP(params, train=True):
    try:
        sigma, B, tau, mix, widenratio, gain, max_rate, y, theta = params
        # For control_gaussianflatten stimulus type, we use gaussian_2dflatten
        spike_trainGCvpfit = []
        ...
        # Use gaussian_2dflatten with optimized parameters
        spatial_rf = gaussian_2dflatten(x_SF, y_SF, sigma, sigma, mix, widenratio, A=1, x0=0, y0=0)
...
# Define bounds for sigma, B, tau, mix, widenratio, gain, max_rate, y, theta
bounds = [(10, 70), (0.00001, 0.05), (2, 25), (0, 3), (1, 7),
          (0.001, 0.01),   # gain
          (150, 400),      # max_rate
          (-600, 4000),
          (-200, 300)]       # theta
...
if __name__ == '__main__':
    ...
    optimal_sigma, optimal_B, optimal_tau, optimal_mix, optimal_widenratio, optimal_gain, optimal_max, optimal_y = result_de.x

    print("Optimal parameters found:")
    print("sigma_x =", optimal_sigma)
    print("B       =", optimal_B)
    print("tau     =", optimal_tau)
    print("mix     =", optimal_mix)
    print("widenratio =", optimal_widenratio)
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_control_gaussianflatten_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_control_gaussianflatten_composite.pkl") 
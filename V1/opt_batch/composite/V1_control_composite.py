...
def objectiveVP(params, train=True):
    try:
        ...
        # For control stimulus type, we use spatial_filterSF
        A = 1  # Fixed A value
        spike_trainGCvpfit = []
...
if __name__ == '__main__':
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_control_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_control_composite.pkl") 
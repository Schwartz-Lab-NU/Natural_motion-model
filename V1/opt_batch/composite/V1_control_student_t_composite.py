...
def objectiveVP(params, train=True):
    try:
        ...
        # For control_student_t stimulus type, we use student_t_2d
        spike_trainGCvpfit = []
...
if __name__ == '__main__':
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_control_student_t_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_control_student_t_composite.pkl") 
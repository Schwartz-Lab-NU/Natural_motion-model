...
stimttype = 'natural_gaussianflatten'
...
def objectiveVP(params, train=True):
    try:
        ...
        # For natural_gaussianflatten stimulus type, we use gaussian_2dflatten
        spike_trainGCvpfit = []
...
if __name__ == '__main__':
    ...
    optimal_sigma, optimal_B, optimal_tau, optimal_mix, optimal_widenratio, optimal_gain, optimal_max, optimal_y, optimal_theta = result_de.x
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_natural_gaussianflatten_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_natural_gaussianflatten_composite.pkl") 
...
def objectiveVP(params, train=True):
    try:
        ...
        # For control_gaussianGen stimulus type, we use generalized_gaussian_2d
        spike_trainGCvpfit = []
...
if __name__ == '__main__':
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_control_gaussianGen_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_control_gaussianGen_composite.pkl") 
...
def objectiveVP(params, train=True):
    ...
    try:
        B, tau, gain, max_rate, y,theta = params
        # For natural stimulus type, we use spatial_filterSF
        stimuli = stimuli_n
        spike_trainGCvpfit = []
...
# Define bounds for B, tau, gain, max_rate, y, theta
bounds = [(0.00001, 0.05), (2, 25),
          (0.001, 0.01),   # gain
              (150, 400),      # max_rate
    (-600, 4000),
    (-200, 300)]       # theta
...
if __name__ == '__main__':
    ...
    optimal_B, optimal_tau,  optimal_gain,optimal_max,optimal_y,optimal_theta= result_de.x
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_natural_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_natural_composite.pkl")

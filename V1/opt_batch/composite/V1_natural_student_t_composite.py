...
def objectiveVP(params, train=True):
    try:
        sigma, B, tau, nu, gain, max_rate, y, theta = params
        # For natural_student_t stimulus type, we use student_t_2d
        spike_trainGCvpfit = []
        ...
        # Use student_t_2d with optimized parameters
        spatial_rf = student_t_2d(x_SF, y_SF, sigma, sigma, nu, A=1, x0=0, y0=0)
...
# Define bounds for sigma, B, tau, nu, gain, max_rate, y, theta
bounds = [(10, 70), (0.00001, 0.05), (2, 25), (0, 2),
          (0.001, 0.01),   # gain
          (150, 400),      # max_rate
          (-600, 4000),
          (-200, 300)]       # theta
...
if __name__ == '__main__':
    ...
    optimal_sigma, optimal_B, optimal_tau, optimal_nu, optimal_gain, optimal_max, optimal_y, optimal_theta = result_de.x
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_natural_student_t_composite.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_natural_student_t_composite.pkl") 
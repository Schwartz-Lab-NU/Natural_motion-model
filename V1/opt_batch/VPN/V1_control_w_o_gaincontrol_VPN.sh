...
#SBATCH --job-name=V1_control_w_o_gaincontrol_VPN  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=V1_control_w_o_gaincontrol_VPN ## standard out and standard error goes to this file
...
python /projects/p32750/repository/Natural_motion-model/V1_control_w_o_gaincontrol_VPN.py 
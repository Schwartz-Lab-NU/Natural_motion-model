...
bounds = [(10, 70), (0.00001, 0.05), (5, 25), (0, 2),
          (0.001, 0.01),   # gain
          (150, 400),      # max_rate
          (-600, 400),
          (10, 100)]       # theta
...
if __name__ == '__main__':
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V1_control_student_t_VPN.pkl", "wb") as f:
        pickle.dump(results, f)

    print("Optimization results saved to V1_control_student_t_VPN.pkl") 
...
#SBATCH --job-name=V3_control_counts  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=V3_control_counts ## standard out and standard error goes to this file
...
python V3_control_counts.py

# Check exit status
if [ $? -eq 0 ]; then
    echo "V3 Control counts optimization completed successfully"
    echo "Results saved to: /projects/p32750/repository/Natural_motion-model/V3/results/V3_control_counts_results.pkl"
else

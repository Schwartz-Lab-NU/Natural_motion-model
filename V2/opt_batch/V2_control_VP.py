...
rfC = np.load('/projects/p32750/repository/Natural_motion-model/rfC_V2.npy')
rfC[rfC < 0.1] = 0
...
if __name__ == '__main__':
    ...
    npy_path = '/projects/p32750/repository/Natural_motion-model/V2_stimuli_c.npy'
    ...
    with open("/projects/p32750/repository/Natural_motion-model/V2_control_counts_test.pkl", "wb") as f:

...
#SBATCH --job-name=V2_natural_VP  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=V2_natural_VP ## standard out and standard error goes to this file
...
python /projects/p32750/repository/Natural_motion-model/V2_natural_VP.py 
...
#SBATCH --job-name=V2_control_counts  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=V2_control_counts ## standard out and standard error goes to this file
...
python /projects/p32750/repository/Natural_motion-model/V2_control_counts.py 